        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.buttonContainer} onPress={vm.onPressSearchDoctors}>
            <View style={styles.iconContainer}>
              <Icon name={'search-location'} size={hp('2.5%')} color={Colors.grey_dark}/>
            </View>
            <Text style={styles.buttonCaption}>{__('search_for_location')}</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.buttonContainer} onPress={vm.onPressPillReminder}>
            <View style={styles.iconContainer}>
              <Icon name={'stream'} color={Colors.grey_dark} size={hp('3.2%')}/>
            </View>
            <Text style={styles.buttonCaption}>{__('vehicle_list')}</Text>
          </TouchableOpacity>
