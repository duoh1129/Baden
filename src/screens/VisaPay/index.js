    ...
    return (
        <Container>
            <ScrollBoardWithHeaderLBButton lButtonCaption={__('back')} rButtonCaption={__('')}
                ...
                <Text style={styles.note}>{__('pay_with_visa')} </Text>

                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                    <Image source={require('@/assets/cards/visa.png')} style={styles.image} resizeMode={"contain"} />
...
export default observer(VisaPay);
